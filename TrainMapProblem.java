...
public class TrainMapProblem {
	 ...
	 *
	 * Implement def shortestPath(self, fromStationName, toStationName) method to
	 * find shortest path between 2 stations
	 *
	 *
	 * 
	 * 
	 ...
	 *
	 * King's Cross St Pancras --- Angel ---- Old Street | \ | | \ | | \ | Russell
	 * Square Farringdon --- Barbican --- Moorgate | / | / | / Holborn --- Chancery
	 * Lane --- St Paul's --- Bank
	 */
	...
	private static class TrainMap {
		 ...
		 * BFS, keeping a track of predecessor paths. Maintain visited nodes to avoid
		 * cycle.
		 */
